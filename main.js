...
const copy = {
  placeholders: {
    result: '반려동물 정보를 입력하면 해석이 표시됩니다.',
    cards: {
      emotion: '정보를 입력하면 감정 카드가 채워집니다.',
      health: '정보를 입력하면 건강운 카드가 채워집니다.',
      bond: '정보를 입력하면 유대감 카드가 채워집니다.',
    },
  },
  table: {
    elementMeaning: '반려동물의 기질을 이루는 기본 요소예요.',
    ganziMeaning: '태어난 날의 간지 흐름을 보여줘요.',
    termMeaning: '계절의 기운이 마음 결에 영향을 줘요.',
    ganziDesc: '간지 흐름이 오늘의 기운 균형에 영향을 줘요.',
    termDesc: '절기의 계절 기운이 감정을 부드럽게 해줘요.',
  },
  sections: {
    analysis: '오행 리듬',
    emotion: '감정',
